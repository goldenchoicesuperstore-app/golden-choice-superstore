...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 shadow-[0_-4px_15px_-1px_rgba(0,0,0,0.05)] h-[72px] flex items-center justify-around px-2 pb-safe">
      ...
      <Link href="/categories" className={`flex flex-col items-center justify-center p-2 rounded-xl transition-colors ${pathname.startsWith('/categories') ? 'text-brand-500' : 'text-gray-500 hover:text-brand-500'}`}>
        <svg xmlns="http://www.w3.org/2000/svg" fill={pathname.startsWith('/categories') ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mb-1">
      ...
      <Link href="/cart" className={`relative flex flex-col items-center justify-center p-2 rounded-xl transition-colors ${pathname === '/cart' ? 'text-brand-500' : 'text-gray-500 hover:text-brand-500'}`}>
      ...
      <Link href="/account" className={`flex flex-col items-center justify-center p-2 rounded-xl transition-colors ${pathname.startsWith('/account') ? 'text-brand-500' : 'text-gray-500 hover:text-brand-500'}`}>
        <svg xmlns="http://www.w3.org/2000/svg" fill={pathname.startsWith('/account') ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mb-1">
