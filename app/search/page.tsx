...
function SearchContent() {
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      <header className="sticky top-0 left-0 right-0 bg-white z-40 shadow-sm px-4 py-3 flex items-center gap-3 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[3px] after:bg-gradient-to-r after:from-[#F5C200] after:to-[#C9980A]">
